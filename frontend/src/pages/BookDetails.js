...
const BookDetails = () => {
  ...
  }, [id, navigate]); // do NOT include toast here (unnecessary dep)
  ...
  const handleMarkHelpful = async (reviewId) => {
    ...
    try {
      ...
      setReviews((prev) =>
        prev.map((r) =>
          r._id === reviewId ? { ...r, helpful: Math.max((r.helpful || 1) - 1, 0) } : r
        )
      );
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center mb-6 justify-between">
              <div className="flex items-center">
                <StarRating rating={book.averageRating} size="large" showValue />
            ...
            <form onSubmit={handleReviewSubmit} className="space-y-4">
              ...
              <div className="flex gap-3">
                <button type="submit" disabled={reviewLoading} className="btn-primary">
                  {reviewLoading ? <div className="spinner h-4 w-4" /> : editingReview ? 'Update Review' : 'Submit Review'}
                </button>
                <button type="button" onClick={cancelReview} className="btn-secondary">
                  Cancel
                </button>
              </div>
            </form>
